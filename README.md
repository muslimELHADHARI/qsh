...
```bash
.venv\Scripts\python app/server.py --host 127.0.0.1 --port 8022 --server-password "qsh123"
```

### 2) Execute remote shell command

```bash
.venv\Scripts\python app/main.py --host 127.0.0.1 --port 8022 --password "qsh123" shell "whoami"
```

### 2b) Start persistent SSH-like session

Use one connection for many commands:

```bash
.venv\Scripts\python app/main.py --host 127.0.0.1 --port 8022 --password "qsh123" session
```
...
```text
shell whoami
upload .\README.md .\remote\readme-copy.md
download .\remote\readme-copy.md .\downloaded\readme-copy.md
exit
```
...
```bash
.venv\Scripts\python app/main.py --host 127.0.0.1 --port 8022 --password "qsh123" upload ".\README.md" ".\remote\readme-copy.md"
```

### 4) Download file

```bash
.venv\Scripts\python app/main.py --host 127.0.0.1 --port 8022 --password "qsh123" download ".\remote\readme-copy.md" ".\downloaded\readme-copy.md"
```
